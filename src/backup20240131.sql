...
CREATE TABLE `program_content` (
  ...
  CONSTRAINT `fk_program_content_program1` FOREIGN KEY (`program_program_id`) REFERENCES `program` (`program_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('g@gmail.com','gaya','nimesha','$2a$10$WyyjUw/MhRfVV4zOM85mmecnQEjpyrs7BrkxZ3fhao/AqtN9Shl.O',1);
...
-- Dump completed on 2024-01-31 13:09:00
